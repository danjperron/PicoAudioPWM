...
while frameLeft>0:
    ...
    if toggle:
        ...
        dma0.move(uctypes.addressof(V0),pwm_even.PWM_CC,nbFrame*4,enable=False)
        # check if previous DMA is done    
        while dma1.isBusy():
             pass
        dma0.enable()
